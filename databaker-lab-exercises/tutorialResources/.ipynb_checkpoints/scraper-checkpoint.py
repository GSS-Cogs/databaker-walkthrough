...
class Scraper(object):
    ...
    def __init__(self, url):
        ...
        elif url == "https://www.fake-website.com/within-example1":
            self.metaData.update({"Example dataset 2": "this is an example dataset for the WITHIN walkthrough."})
            self.distribution.tabs = loadxlstabs(self.location + "databakerWithinExample.xls", verbose=False)
